...
export const DAMAGED_TILE_HP_PER_SUPPLY = 4;
// Full hole rebuild = 4 supplies; must stay below TILE_BUILD_SALVAGE_COST.
export const BROKEN_TILE_HP_PER_SUPPLY = 2.5;
